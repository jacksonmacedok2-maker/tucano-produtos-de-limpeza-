...
const About: React.FC = () => {
  return (
    <section id="sobre-nos" className="py-16 sm:py-24 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="lg:w-1/2 order-1 lg:order-2">
            <span className="text-tucano-blue font-black uppercase tracking-[0.3em] text-[10px] sm:text-sm mb-4 sm:mb-6 block">Nossa História</span>
            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-black text-slate-900 mb-6 sm:mb-8 leading-tight tracking-tight">
              ...
              <span className="text-tucano-blue relative">
                cuidado de família
                <span className="absolute bottom-1 left-0 w-full h-3 bg-tucano-yellow/40 -z-10"></span>
              </span>
            </h2>
            <p className="text-slate-700 text-base sm:text-xl mb-4 sm:mb-6 leading-relaxed font-bold">
            ...
            <p className="text-slate-600 text-base sm:text-lg mb-6 sm:mb-10 leading-relaxed italic font-medium">
            ...
            <div className="flex items-center gap-8 sm:gap-12">
               <div>
                  ...
                  <p className="text-slate-500 text-[9px] sm:text-xs font-bold uppercase tracking-widest mt-1">Anos de estrada</p>
               </div>
               <div>
                  <p className="text-3xl sm:text-5xl font-black text-tucano-blue tracking-tighter">1M+</p>
                  <p className="text-slate-500 text-[9px] sm:text-xs font-bold uppercase tracking-widest mt-1">Famílias atendidas</p>
               </div>
            </div>
          </div>
        </div>
