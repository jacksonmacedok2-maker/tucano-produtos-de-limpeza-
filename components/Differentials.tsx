...
const Differentials: React.FC = () => {
  return (
    <section id="diferenciais" className="py-16 sm:py-32 bg-slate-50 relative overflow-hidden border-y border-slate-100">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {DIFFERENTIALS.map((diff, idx) => (
                <div key={idx} className="bg-white p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-500 border border-white group">
                  <div className="mb-6 bg-slate-50 w-16 h-16 rounded-2xl flex items-center justify-center shadow-sm transition-transform duration-500 group-hover:scale-110">
